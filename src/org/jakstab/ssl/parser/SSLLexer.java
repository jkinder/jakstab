...
tryAgain:
	...
	public final void mWS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case '\t':  case '\u000c':  case ' ':
		{
			...
			do {
				...
				default:
				{
					if ( _cnt2431>=1 ) { break _loop2431; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
				}
				_cnt2431++;
			} while (true);
	...
	protected final void mDIGITS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt2442>=1 ) { break _loop2442; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mHEXDIGITS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt2445>=1 ) { break _loop2445; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt2445++;
		} while (true);
	...
	protected final void mFLOATNUM(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt2452>=1 ) { break _loop2452; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt2454>=1 ) { break _loop2454; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	public final void mFLOAT_OR_NUM(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if (((_tokenSet_1.member(LA(1))) && (_tokenSet_3.member(LA(2))) && (_tokenSet_3.member(LA(3))) && (true))) {
			...
			try {
				...
				synPredMatched2459 = false;
			}
			rewind(_m2459);
inputState.guessing--;
		}
		if ( synPredMatched2459 ) {
			mFLOATNUM(false);
			if ( inputState.guessing==0 ) {
				_ttype = FLOATNUM;
			}
...
inputState.guessing--;
			...
			if ( synPredMatched2461 ) {
				...
				boolean synPredMatched2463 = false;
				if (((LA(1)=='-') && (true) && (true) && (true))) {
					int _m2463 = mark();
					synPredMatched2463 = true;
					inputState.guessing++;
					try {
						{
						mMINUS(false);
						...
						synPredMatched2463 = false;
					}
					rewind(_m2463);
inputState.guessing--;
				}
				if ( synPredMatched2463 ) {
					mMINUS(false);
					if ( inputState.guessing==0 ) {
						_ttype = MINUS;
					}
	...
	protected final void mASSIGNTYPE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt2494>=1 ) { break _loop2494; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	public final void mASSIGNTYPE_OR_MUL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ((LA(1)=='*') && (LA(2)=='f') && (LA(3)=='d') && (LA(4)=='q')) {
			...
			boolean synPredMatched2497 = false;
			if (((LA(1)=='*') && (_tokenSet_4.member(LA(2))) && (_tokenSet_5.member(LA(3))))) {
				int _m2497 = mark();
				synPredMatched2497 = true;
				inputState.guessing++;
				try {
					{
					mASSIGNTYPE(false);
					...
					synPredMatched2497 = false;
				}
				rewind(_m2497);
inputState.guessing--;
			}
			if ( synPredMatched2497 ) {
				mASSIGNTYPE(false);
				if ( inputState.guessing==0 ) {
					_ttype = ASSIGNTYPE;
				}
	...
	public final void mXOR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		match('^');
		{
		boolean synPredMatched2508 = false;
		if (((LA(1)=='"'))) {
			int _m2508 = mark();
			synPredMatched2508 = true;
			inputState.guessing++;
			try {
				{
				match('"');
				...
				synPredMatched2508 = false;
			}
			rewind(_m2508);
inputState.guessing--;
		}
		if ( synPredMatched2508 ) {
			_saveIndex=text.length();
			match('"');
			text.setLength(_saveIndex);
			{
	...
	private static final long[] mk_tokenSet_5() {
		long[] data = { 287953299221512192L, 0L, 0L};
		return data;
	}
