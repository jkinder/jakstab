/*
 * RTLLabel.java - This file is part of the Jakstab project.
...
/**
 * A label which uniquely identifies a RTLStatement in the program. It
...
public class RTLLabel implements Location {
	...
	private static final Logger logger = Logger.getLogger(RTLLabel.class);
